    ...
    <nav class="navbar col-3 d-none d-md-block py-md-3 px-md-5 py-2 bg-white">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-flex align-items-center">
                ...
                <a class="nav-link" href="{{ route('customer.index') }}">Покупатели</a>
            </li>
            <hr/>
            <li class="nav-item d-flex align-items-center">
        ...
        <div class="container fixed-bottom d-block d-md-none pb-2">
            ...
            <div id="mobile-nav" class="d-flex flex-row">
                ...
                <div class="col-10 col-sm-8 pe-2">
                    ...
                    <div
                        class="container bg-white d-flex align-items-center justify-content-evenly rounded-pill border border-primary">
                        <nav class="navbar">
                            <button
                    ...
                    <form id="addOrderForm" action="{{ route('order.store') }}" method="POST">
                        ...
                        <div class="row g-2 align-items-end mb-3">
                            ...
                            <div class="col-6">
                                ...
                                <input name="glasses_model" id="glasses_model" type="text"
                                       class="glasses_model form-control">
                            </div>
                        </div>
